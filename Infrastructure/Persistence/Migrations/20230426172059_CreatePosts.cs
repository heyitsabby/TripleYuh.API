        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    type = table.Column<string>(type: "text", nullable: false, defaultValue: "Text"),
                    url = table.Column<string>(type: "text", nullable: true),
                    body = table.Column<string>(type: "character varying(42000)", maxLength: 42000, nullable: true)
                },
                constraints: table =>
                {
