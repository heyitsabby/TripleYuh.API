...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230510143330_AddVoting")]
            ...
            modelBuilder.Entity("Domain.Entities.CommentVote", b =>
                {
                    ...
                    b.HasIndex("AccountId")
                        .HasDatabaseName("ix_comment_votes_account_id");
            ...
            modelBuilder.Entity("Domain.Entities.PostVote", b =>
                {
                    ...
                    b.HasIndex("AccountId")
                        .HasDatabaseName("ix_post_votes_account_id");
            ...
            modelBuilder.Entity("Domain.Entities.CommentVote", b =>
                {
                    b.HasOne("Domain.Entities.Account", "Account")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_comment_votes_accounts_account_id");
            ...
            modelBuilder.Entity("Domain.Entities.PostVote", b =>
                {
                    b.HasOne("Domain.Entities.Account", "Account")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_votes_accounts_account_id");
